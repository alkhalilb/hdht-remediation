...
// EXIT CASE 1: Leg Pain with Walking
export const exitCase1: RemediationCase = {
  id: 'exit-claudication-001',
  title: 'Leg Pain with Walking in an Older Adult',
  purpose: 'exit',
  scaffoldingLevel: 'none',
  patient: {
    name: 'Robert Martinez',
  ...
  chiefComplaint: 'Leg pain when walking for 2 months',
  vitalSigns: {
    bp: '148/92',
    hr: 78,
    rr: 14,
  ...
  illnessScript: {
    hpiDetails: {
      onset: 'Gradual onset over past 2 months, progressively getting worse',
      location: 'Both calves, left worse than right',
      duration: 'Comes on after walking about 2 blocks, resolves with rest',
      character: 'Cramping, aching pain',
      aggravatingFactors: ['Walking', 'Climbing stairs', 'Walking uphill'],
      relievingFactors: ['Stopping and resting for 2-3 minutes', 'Standing still'],
      timing: 'Predictable - always occurs at same walking distance',
      severity: '6/10 when walking, 0/10 at rest',
      associatedSymptoms: ['Feet feel cold sometimes', 'Noticed less hair on lower legs'],
      negativeSymptoms: ['No pain at rest', 'No numbness', 'No back pain', 'No swelling',
        'No skin ulcers', 'No chest pain with exertion'],
    },
    pmh: ['Hypertension for 10 years', 'High cholesterol', 'Type 2 diabetes for 5 years'],
    ...
    familyHistory: [
      ...
      { relation: 'Brother', condition: 'Diabetes, had bypass surgery' },
    ],
    socialHistory: {
      smoking: 'Smoked 1 pack/day for 35 years, quit 5 years ago',
      alcohol: 'Occasional glass of wine',
      drugs: 'None',
      occupation: 'Retired accountant, sedentary work for 35 years',
      livingSituation: 'Lives with wife in house',
      diet: 'Trying to eat healthier since diabetes diagnosis',
      exercise: 'Used to walk for exercise but stopped due to leg pain',
    },
    ros: {
      cardiovascular: {
        positives: ['Leg pain with walking', 'Cold feet'],
        negatives: ['No chest pain', 'No palpitations', 'No orthopnea', 'No PND', 'No leg swelling'],
      },
      musculoskeletal: {
        positives: ['Calf cramping with activity'],
        negatives: ['No back pain', 'No joint pain', 'No muscle weakness'],
      },
      neurological: {
        positives: [],
        negatives: ['No numbness', 'No tingling', 'No weakness', 'No bowel/bladder changes'],
      },
      constitutional: {
        positives: [],
        negatives: ['No fever', 'No weight loss', 'No fatigue'],
      },
    },
    primaryDiagnosis: 'Claudication',
    differentialDiagnoses: ['Peripheral artery disease', 'Spinal stenosis', 'Mechanical back pain', 'Venous claudication'],
  },
  expertContent: {
    expectedHypotheses: {
      mustConsider: ['Claudication', 'Peripheral artery disease', 'Spinal stenosis'],
      shouldConsider: ['Mechanical back pain', 'Venous claudication'],
      acceptable: ['Deep vein thrombosis', 'Chronic compartment syndrome', 'Neuropathy'],
    },
    discriminatingQuestions: {
      'Claudication': {
        supports: ['Leg pain with walking', 'Relief with rest', 'Reproducible distance', 'Risk factors (smoking, diabetes)'],
        refutes: ['Pain at rest', 'No relation to walking', 'No vascular risk factors'],
        keyQuestions: ['Walking distance', 'Rest relief', 'Smoking history', 'Vascular risk factors'],
      },
      'Spinal Stenosis': {
        supports: ['Pain with standing', 'Relief with bending forward', 'Bilateral symptoms', 'Back pain'],
        refutes: ['No positional component', 'Unilateral', 'No back symptoms'],
        keyQuestions: ['Position effects', 'Shopping cart sign', 'Back pain', 'Bilateral vs unilateral'],
      },
      'Peripheral Artery Disease': {
        supports: ['Cold extremities', 'Hair loss on legs', 'Weak pulses', 'Skin changes'],
        refutes: ['Normal pulses', 'No skin changes', 'Warm extremities'],
        keyQuestions: ['Pulse exam', 'Skin changes', 'Temperature', 'Prior vascular disease'],
      },
    },
    requiredTopics: [
      'onset', 'location', 'character', 'aggravating', 'relieving', 'timing',
      'smoking', 'pmh', 'medications', 'family_history', 'exercise_tolerance', 'prior_episodes',
    ],
    expertQuestionCount: { min: 15, max: 25 },
  },
  scaffolding: noScaffolding,
